...
@endif
          ...
          <form class="mx-auto" method="post" action="{{route('post.update',$post->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
      ...
      <div class="form-group">
        ...
        <select name="category" class="form-control">
          ...
          @endforeach
			...
			<div class="form-group">
				<input type="submit" name="btnsubmit" class="btn btn-success form-control" value="Update">
			</div>
		</form>
